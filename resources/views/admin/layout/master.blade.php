          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/admin/home_slider/" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Slider</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/home_video/" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Video</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/serviceinfo/" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Services Info</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/home_service/" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Services</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/portfolioinfo/" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Portfolio Info</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/admin/home_portfolio/" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Portfolio</p>
                    </a>
                  </li>
